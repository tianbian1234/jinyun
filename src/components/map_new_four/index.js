...
class Mapnewfour extends React.Component {
  constructor(props) {
    super(props);
  }
  drawmap() {
  ...
  render() {
    ...
    return (
      <div style={this.props.style} className="mapBoxnewfour">
        <div className="title">{this.props.title}</div>
        {backShow && <div className="back"></div>}
        <div style={{width:mapWidth,height:mapHeight}} className="backmap"></div>
        <div
          style={{width:mapWidth,height:mapHeight,marginLeft:mapLeft,marginTop:mapTop}}
          ref="map"
          className="mapTu">
        </div>
      </div>
