...
import * as enorthScreenAction from 'actions/enorth_screen';
...
class Zone extends React.Component {
  ...
  componentWillMount() {
    ...
    this.props.enorthScreenAction.fetchTopicList();
    this.props.enorthScreenAction.fetchHistoryList();
  ...
  render() {
    ...
    const topicData = this.props.topicData.completed ? this.props.topicData.result.subjectList : [];
    ...
    return (
      <div className="jinyun-z-one container-bg" style={{overflow:'hidden'}}>
        <div className="left">
...
export default connect(
  (state) =>{
    return {
      ...
      topicData: state.topic.selectTopic,
  ...
  (dispatch) => {
    return {
      ...
      enorthScreenAction: bindActionCreators(enorthScreenAction, dispatch),
